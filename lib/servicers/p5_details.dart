...
class P5details extends StatelessWidget{
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("Name: Nagesh",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            ...
            Text("Experience: 5 years",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            Text("Rating: 4.2/5",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            RaisedButton(
