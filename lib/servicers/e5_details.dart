...
class E5details extends StatelessWidget{
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("Name: Immanuel",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            ...
            Text("Experience: 7 years",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            Text("Rating: 4.0/5",style: TextStyle(fontSize: 20),),
            SizedBox(
              height: 5,
            ),
            RaisedButton(
