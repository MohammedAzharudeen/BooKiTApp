...
class Carpenters extends StatelessWidget {
  Carpenters({this.auth, this.onSignOut});
  final BaseAuth auth;
  ...
  Column getCardByTitle(String title) {
    ...
    if(title == "Carpenter1")
      img="assets/icon.png";
    else if(title == "Carpenter2")
      img="assets/icon.png";
    else if(title == "Carpenter3")
      img="assets/icon.png";
    else if(title == "Carpenter4")
      img="assets/icon.png";
    else if(title == "Carpenter5")
      img="assets/icon.png";
    else
      img="assets/icon.png";
    return Column(
